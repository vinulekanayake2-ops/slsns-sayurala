...
function AdminLogin() {
    ...
    const handleLogin = async (e)=>{
        ...
        if (username === "admin" && password === "admin") {
            ...
            const { loginAdmin } = await __turbopack_context__.A("[project]/app/actions.ts [app-ssr] (ecmascript, async loader)"); // Dynamic import to avoid build issues if needed, or top level import
            await loginAdmin();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bce827e0._.js.map
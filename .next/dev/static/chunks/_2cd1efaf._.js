...
function AdminLogin() {
    ...
    const handleLogin = async (e)=>{
        ...
        if (username === "admin" && password === "admin") {
            ...
            const { loginAdmin } = await __turbopack_context__.A("[project]/app/actions.ts [app-client] (ecmascript, async loader)"); // Dynamic import to avoid build issues if needed, or top level import
            await loginAdmin();
...
//# sourceMappingURL=_2cd1efaf._.js.map